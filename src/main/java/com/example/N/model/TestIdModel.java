...
public class TestIdModel implements Serializable {
    ...
    // 全フィールドを含むコンストラクタ
    public TestIdModel(String studentNo, String subjectCd, String schoolCd, Integer no) {
    ...
    public boolean equals(Object o) {
        ...
        TestIdModel testId = (TestIdModel) o;
